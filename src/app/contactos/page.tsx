                            ...
                            <div className="contact-info-wrapper">
                                ...
                                <div className="info-cards">
                                    <div className="info-card">
                                        ...
                                        <p className="info-card-text">
                                            ...
                                            2625-187 Póvoa de Santa Iria<br />
                                            Portugal
                                        </p>
                                    </div>
                                    ...
                                    <div className="info-card">
                                        ...
                                        <p className="info-card-text">
                                            <a href="tel:963908617">963 908 617</a><br />
                                            <a href="tel:219591522">21 959 15 22</a>
                                        </p>
                                    </div>
                                    ...
                                    <div className="info-card">
                                        ...
                                        <p className="info-card-text">
                                            <a href="mailto:3gwine@gmail.com">3gwine@gmail.com</a><br />
                                            <a href="mailto:Virtual.mm.wines@gmail.com">Virtual.mm.wines@gmail.com</a>
                                        </p>
                                    </div>
                                ...
                                <div className="social-section">
                                    ...
                                    <div className="social-links-contact">
                                        ...
                                        <a href="https://wa.me/351912345678" target="_blank" rel="noopener noreferrer" className="social-link-contact" aria-label="WhatsApp">
                                    ...
                                    <div className="qr-codes-section">
                                        <h3 className="qr-codes-title">Siga-nos no Instagram</h3>
                                        <div className="qr-grid">
                                            <div className="qr-item">
                                                <div className="qr-image-wrapper">
                                                    <Image
                                                        src="/images/contactos/qr-3gwine.jpg"
                                                        alt="Instagram 3G Wine"
                                                        fill
                                                        style={{ objectFit: 'cover' }}
                                                    />
                                                </div>
                                                <p className="qr-label primary">@3GWINE</p>
                                            </div>
                                            <div className="qr-item">
                                                <div className="qr-image-wrapper">
                                                    <Image
                                                        src="/images/contactos/qr-virtualmm.jpg"
                                                        alt="Instagram Virtual MM Wines"
                                                        fill
                                                        style={{ objectFit: 'cover' }}
                                                    />
                                                </div>
                                                <p className="qr-label secondary">@VIRTUAL.MM.WINES</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
